    ...
    >
      ...
      >
        ...
        <ul className="space-y-2 text-sm text-text.DEFAULT">
          ...
          <li>
            <strong>Size:</strong> {formatSize(fileDetails.size)}
          </li>
          <li>
            <strong>Uploaded:</strong> {new Date(fileDetails.uploadedAt).toLocaleString()}
          </li>
          <li>
            <strong>Type:</strong> {fileDetails.type}
          </li>
          <li>
            <strong>Sharing:</strong> {fileDetails.sharingStatus}
          </li>
          <li>
            <strong>Versions:</strong> {fileDetails.versionCount}
          </li>
        </ul>
